...
/**
 * Correction service with dependency injection
 */
export class CorrectionService {
  ...
  async createCorrection(request: CreateCorrectionRequest): Promise<Correction> {
    return this.apiClient.post<Correction>(API_CONFIG.ENDPOINTS.CORRECTIONS, request);
  }
  ...
  async getAllCorrections(): Promise<Correction[]> {
    return this.apiClient.get<Correction[]>(API_CONFIG.ENDPOINTS.CORRECTIONS);
  }
  ...
  async toggleFavorite(id: number): Promise<void> {
    return this.apiClient.put<void>(`${API_CONFIG.ENDPOINTS.CORRECTIONS}/${id}/favorite`);
  }
  ...
  async getFavorites(): Promise<Correction[]> {
    return this.apiClient.get<Correction[]>(API_CONFIG.ENDPOINTS.FAVORITES);
  }
  ...
  async getUserGoodExpressions(userId: number): Promise<Correction[]> {
    ...
    return this.apiClient.get<Correction[]>(endpoint);
  }
}

// Singleton instance for backward compatibility
export const correctionService = new CorrectionService(apiClient);
